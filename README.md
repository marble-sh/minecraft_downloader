...
[![Build Status](https://travis-ci.org/marble-sh/minecraft_downloader.svg?branch=master)](https://travis-ci.org/marble-sh/minecraft_downloader)

A very simple application to download the latest version of the minecraft server .jar.

Downloads for Windows, Mac, and Linux can be found on the [releases](https://github.com/marble-sh/minecraft_downloader/releases/latest) page.
